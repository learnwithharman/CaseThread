    ...
    <div className="min-h-screen p-6 md:p-12 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full flex flex-col gap-8 z-10">
        <div className="flex justify-between items-center w-full mb-4">
          <div className="text-sm text-muted">Protected Route Verification</div>
          <button onClick={logout} className="text-sm hover:text-white transition-colors">
            Logout
          </button>
        </div>
        ...
        <div className="text-center text-xs text-muted">
          ...
          <p className="mt-1">
            CaseThread Architecture System • Day 7 Routing Integrated
          </p>
        </div>
      </div>
    </div>
